...
class User(DataBaseModel, AuthUser):
    ...
    language = CharField(max_length=32, null=True, help_text="English|Chinese|Turkish", default="Chinese" if "zh_CN" in os.getenv("LANG", "") else "English", index=True)
...
class Knowledgebase(DataBaseModel):
    ...
    language = CharField(max_length=32, null=True, default="Chinese" if "zh_CN" in os.getenv("LANG", "") else "English", help_text="English|Chinese|Turkish", index=True)
